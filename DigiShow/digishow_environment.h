...
class DigishowEnvironment : public QObject
{
    ...
    Q_PROPERTY(DigishowCueManager *cueManager READ cueManager NOTIFY cueManagerChanged)
...
public:
    ...
    enum InterfaceMode {
        ...
        InterfaceRiocArduinoMicro = INTERFACE_RIOC_ARDUINO_MICRO,
        InterfaceRiocAladdin      = INTERFACE_RIOC_ALADDIN,
        InterfaceRiocPlc1         = INTERFACE_RIOC_PLC1,
        InterfaceRiocPlc2         = INTERFACE_RIOC_PLC2,
        InterfaceRiocAladdin1     = INTERFACE_RIOC_ALADDIN1,
        InterfaceRiocAladdin2     = INTERFACE_RIOC_ALADDIN2,
        InterfaceRiocAladdin3     = INTERFACE_RIOC_ALADDIN3,
    ...
    enum EndpointType {
        ...
        EndpointAudioInLevelDb    = ENDPOINT_AUDIOIN_LEVEL_DB,
        ...
        EndpointScreenPlaying     = ENDPOINT_SCREEN_PLAYING,
        EndpointScreenEnd         = ENDPOINT_SCREEN_END,
        EndpointScreenTimecode    = ENDPOINT_SCREEN_TIMECODE,
        EndpointAPlayMedia        = ENDPOINT_APLAY_MEDIA,
        EndpointAPlayPlaying      = ENDPOINT_APLAY_PLAYING,
        EndpointAPlayEnd          = ENDPOINT_APLAY_END,
        EndpointAPlayTimecode     = ENDPOINT_APLAY_TIMECODE,
        EndpointMPlayMedia        = ENDPOINT_MPLAY_MEDIA,
        EndpointMPlayPlaying      = ENDPOINT_MPLAY_PLAYING,
        EndpointMPlayEnd          = ENDPOINT_MPLAY_END,
        EndpointMPlayTimecode     = ENDPOINT_MPLAY_TIMECODE,
        ...
        EndpointLfoTimecode       = ENDPOINT_LFO_TIMECODE,
        ...
        EndpointLaunchPlaying     = ENDPOINT_LAUNCH_PLAYING,
        EndpointLaunchEnd         = ENDPOINT_LAUNCH_END,
        EndpointLaunchTimecode    = ENDPOINT_LAUNCH_TIMECODE,
    ...
    Q_INVOKABLE DigishowCueManager *cueManager() { return g_app->cueManager(); }
    ...
    Q_INVOKABLE static bool isRiocUserDevice(int mode);
